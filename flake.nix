{
  description = "codefly toolbox plugin: nix";
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        packages = {
          ...
          "agents-toolbox-nix-0.0.1" = toolbox;
        };
